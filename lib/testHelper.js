...
class TestHelper {
    ...
    async sendStatus(score, bestHash, genesisHash) {
        ...
        await this.p2psocket.sendExtensionMessage("block-propagation", new codechain_primitives_3.U256(0), msg.rlpBytes(), false);
    }
    ...
    async sendParcelSyncMessage(parcels) {
        ...
        await this.p2psocket.sendExtensionMessage("parcel-propagation", new codechain_primitives_3.U256(0), message.rlpBytes(), false);
    }
