...
export class Sync1 {
    ...
    static fromBytes(bytes: Buffer): Sync1 {
...
export class Sync2 {
    ...
    static fromBytes(bytes: Buffer): Sync2 {
        const decoded = RLP.decode(bytes);
        const protocolId = parseInt(decoded[0].toString("hex"), 16);
...
export class Ack {
    ...
    static fromBytes(bytes: Buffer): Ack {
        const decoded = RLP.decode(bytes);
        const protocolId = parseInt(decoded[0].toString("hex"), 16);
...
export class Nack {
    ...
    static fromBytes(bytes: Buffer): Nack {
        const decoded = RLP.decode(bytes);
        const protocolId = parseInt(decoded[0].toString("hex"), 16);
...
export class NegotiationRequest {
    ...
    static fromBytes(bytes: Buffer): NegotiationRequest {
        const decoded = RLP.decode(bytes);
        const protocolId = parseInt(decoded[0].toString("hex"), 16);
...
export class NegotiationResponse {
    ...
    static fromBytes(bytes: Buffer): NegotiationResponse {
        const decoded = RLP.decode(bytes);
        const protocolId = parseInt(decoded[0].toString("hex"), 16);
...
export class Encrypted {
    ...
    static fromBytes(bytes: Buffer): Encrypted {
        const decoded = RLP.decode(bytes);
        const protocolId = parseInt(decoded[0].toString("hex"), 16);
...
export class Unencrypted {
    ...
    static fromBytes(bytes: Buffer): Unencrypted {
        const decoded = RLP.decode(bytes);
        const protocolId = parseInt(decoded[0].toString("hex"), 16);
...
export class SignedMessage {
    ...
    static fromBytes(bytes: Buffer, nonce: U128): SignedMessage {
        const decoded = RLP.decode(bytes);
